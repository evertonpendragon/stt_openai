...
def traduzir_texto(conteudo):
    prompt = (
        "Melhore os textos enviados aqui. Mantenha os detalhes, nomes e títulos de personagens. Preserve as citações. Preze pela coerência e coesão da história, corrigindo passagens repetitivas."
...
input_file = "melhorator_input/input.txt"
output_file = "melhorator_output/output.txt"
